...
.propertyIsEnumerable, u=Object.getOwnPropertyDescriptor, s=u&&!a.call( {
  1:2
}
, 1)?function(t) {
  var e=u(this, t);
...
, L="__core-js_shared__", U=n[L]||k(L,  {
}
), M=Function.toString;
...
var _, N, C, F=U.inspectSource, B=n.WeakMap, D="function"==typeof B&&/native code/.test(F(B)), q=!1, z=e(function(t) {
  ...
  version:"3.6.5", mode:"global", copyright:"© 2020 Denis Pushkarev (zloirock.ru)"
}
)
}
...
a>u;
u++)if((t||u in i)&&i[u]===r)return t||u||0;
return!t&&-1
}
}
, vt= {
  includes:dt(!0), indexOf:dt(!1)
}
...
, xt=function(t, e) {
  for(var r=Et(e), n=I.f, o=R.f, i=0;
i<r.length;
i++) {
  var a=r[i];
w(t, a)||n(t, a, o(e, a))
...
, Pt=Ot.NATIVE="N", It=Ot.POLYFILL="P", Tt=Ot, kt=R.f, Lt=function(t, e) {
  var r, o, i, a, u, s=t.target, c=t.global, f=t.stat;
if(r=c?n:f?n[s]||k(s,  {
}
):(n[s]|| {
}
).prototype)for(o in e) {
...
, Wt=i?Object.defineProperties:function(t, e) {
  j(t);
for(var r, n=zt(e), o=n.length, i=0;
o>i;
)I.f(t, r=n[i++], e[r]);
return t
}
...
,  {
  fill:function(t) {
  for(var e=Ut(this), r=ft(e.length), n=arguments.length, o=pt(n>1?arguments[1]:void 0, r), i=n>2?arguments[2]:void 0, a=void 0===i?r:pt(i, r);
a>o;
)e[o++]=t;
return e
}
...
return function(u, s, c, f) {
  for(var l, h, p=Ut(u), v=d(p), g=re(s, c, 3), y=ft(v.length), m=0, b=f||ue, w=e?b(u, y):r?b(u, 0):void 0;
y>m;
m++)if((a||m in v)&&(h=g(l=v[m], m, p), t))if(e)w[m]=h;
else if(h)switch(t) {
  case 3:return!0;
case 5:return l;
case 6:return m;
...
, fe= {
  forEach:ce(0), map:ce(1), filter:ce(2), some:ce(3), every:ce(4), find:ce(5), findIndex:ce(6)
}
, le=Object.defineProperty, he= {
}
, pe=function(t) {
  throw t
}
...
var r=[][t], n=!!w(e, "ACCESSORS")&&e.ACCESSORS, a=w(e, 0)?e[0]:pe, u=w(e, 1)?e[1]:void 0;
...
var xe=function(t, e, r, n, o, i, a, u) {
  for(var s, c=o, f=0, l=!!a&&re(a, u, 3);
f<n;
) {
  if(f in r) {
...
,  {
  flat:function() {
  var t=arguments.length?arguments[0]:void 0, e=Ut(this), r=ft(e.length), n=ue(e, 0);
...
), ke=V("IE_PROTO"), Le=Object.prototype, Ue=Te?Object.getPrototypeOf:function(t) {
...
, Me=qt("iterator"), _e=!1;
[].keys&&("next"in(je=[].keys())?(Re=Ue(Ue(je)))!==Object.prototype&&(Oe=Re):_e=!0), null==Oe&&(Oe= {
}
), w(Oe, Me)||T(Oe, Me, function() {
  return this
}
);
var Ne= {
  IteratorPrototype:Oe, BUGGY_SAFARI_ITERATORS:_e
}
, Ce=I.f, Fe=qt("toStringTag"), Be=function(t, e, r) {
...
, qe=Ne.IteratorPrototype, ze=function() {
  return this
}
, We=function(t, e, r) {
  var n=e+" Iterator";
...
switch(t) {
  case Xe:case Ye:case Je:return function() {
  return new r(this, t)
}
}
return function() {
...
, l=e+" Iterator", h=!1, p=t.prototype, d=p[He]||p["@@iterator"]||o&&p[o], v=!Ve&&d||f(o), g="Array"==e&&p.entries||d;
...
), p[He]!==v&&T(p, He, v), De[e]=v, o)if(s= {
  values:f(Ye), keys:i?v:f(Xe), entries:f(Je)
}
, a)for(c in s)(Ve||h||!(c in p))&&rt(p, c, s[c]);
else Lt( {
  target:e, proto:!0, forced:Ve||h
}
, s);
return s
}
...
Ze(String, "String", function(t) {
  rr(this,  {
  type:er, string:String(t), index:0
}
)
}
, function() {
...
;
cr[qt("toStringTag")]="z";
var fr="[object z]"===String(cr), lr=qt("toStringTag"), hr="Arguments"==h(function() {
  return arguments
}
()), pr=fr?h:function(t) {
  var e, r, n;
...
, gr=function(t) {
  var e, r, n, o, i, a, u=Ut(t), s="function"==typeof this?this:Array, c=arguments.length, f=c>1?arguments[1]:void 0, l=void 0!==f, h=vr(u), p=0;
if(l&&(f=re(f, c>2?arguments[2]:void 0, 2)), null==h||s==Array&&ur(h))for(r=new s(e=ft(u.length));
e>p;
p++)a=l?f(u[p], p):u[p], sr(r, p, a);
else for(i=(o=h.call(u)).next, r=new s;
!(n=i.call(o)).done;
p++)a=l?or(o, f, [n.value, p], !0):n.value, sr(r, p, a);
return r.length=p, r
}
, yr=qt("iterator"), mr=!1;
try {
...
var xr=vt.includes, Ar=de("indexOf",  {
  ACCESSORS:!0, 1:0
}
);
Lt( {
...
var Or="Array Iterator", Rr=et.set, jr=et.getterFor(Or), Pr=Ze(Array, "Array", function(t, e) {
  Rr(this,  {
  type:Or, target:g(t), index:0, kind:e
}
)
}
, function() {
...
,  {
  of:function() {
  for(var t=0, e=arguments.length, r=new("function"==typeof this?this:Array)(e);
e>t;
)sr(r, t, arguments[t++]);
return r.length=e, r
}
...
if(ur(u)) {
  for(s=0, c=ft(t.length);
c>s;
s++)if((f=o?p(j(h=t[s])[0], h[1]):p(t[s]))&&f instanceof e)return f;
return new e(!1)
}
a=u.call(t)
}
...
, qr=function(t, e, r) {
  var i=-1!==t.indexOf("Map"), a=-1!==t.indexOf("Weak"), u=i?"set":"add", s=n[t], c=s&&s.prototype, f=s, l= {
}
, h=function(t) {
  var e=c[t];
...
, Gr=I.f, $r=Cr.fastKey, Vr=et.set, Hr=et.getterFor, Xr= {
  ...
  Br(t, o, e), Vr(t,  {
  type:e, index:Jt(null), first:void 0, last:void 0, size:0
}
...
return zr(o.prototype,  {
  clear:function() {
  for(var t=a(this), e=t.index, r=t.first;
r;
...
, forEach:function(t) {
  for(var e, r=a(this), n=re(t, arguments.length>1?arguments[1]:void 0, 3);
e=e?e.next:r.first;
...
, Xr);
fr||rt(Object.prototype, "toString", fr? {
}
.toString:function() {
...
var sn=function() {
  for(var t, e=j(this), r=ee(e.delete), n=!0, o=0, i=arguments.length;
o<i;
o++)t=r.call(e, arguments[o]), n=n&&t;
return!!n
}
;
Lt( {
...
,  {
  every:function(t) {
  var e=j(this), r=fn(e), n=re(t, arguments.length>1?arguments[1]:void 0, 3);
...
,  {
  filter:function(t) {
  var e=j(this), r=fn(e), n=re(t, arguments.length>1?arguments[1]:void 0, 3), o=new(hn(e, it("Map"))), i=ee(o.set);
return Fr(r, function(t, r) {
...
,  {
  merge:function(t) {
  for(var e=j(this), r=ee(e.set), n=0;
n<arguments.length;
...
,  {
  reduce:function(t) {
  var e=j(this), r=fn(e), n=arguments.length<2, o=n?void 0:arguments[1];
...
var dn="\t\n\v\f\r                　\u2028\u2029\ufeff", vn="["+dn+"]", gn=RegExp("^"+vn+vn+"*"), yn=RegExp(vn+vn+"*$"), mn=function(t) {
  return function(e) {
  var r=String(v(e));
...
, bn= {
  start:mn(1), end:mn(2), trim:mn(3)
}
, wn=wt.f, Sn=R.f, En=I.f, xn=bn.trim, An="Number", On=n[An], Rn=On.prototype, jn=h(Jt(Rn))==An, Pn=function(t) {
...
for(a=(i=c.slice(2)).length, u=0;
u<a;
u++)if((s=i.charCodeAt(u))<48||s>o)return NaN;
return parseInt(i, n)
}
return+c
}
...
, kn=i?wn(On):"MAX_VALUE, MIN_VALUE, NaN, NEGATIVE_INFINITY, POSITIVE_INFINITY, EPSILON, isFinite, isInteger, isNaN, isSafeInteger, MAX_SAFE_INTEGER, MIN_SAFE_INTEGER, parseFloat, parseInt, isInteger".split(", "), Ln=0;
kn.length>Ln;
Ln++)w(On, In=kn[Ln])&&!w(Tn, In)&&En(Tn, In, Sn(On, In));
...
var Mn=Math.floor, _n=function(t) {
...
var Kn=c.f, Gn=function(t) {
  return function(e) {
  for(var r, n=g(e), o=zt(n), a=o.length, u=0, s=[];
a>u;
...
,  {
  ...
  for(var e, r, n=g(t), o=R.f, i=Et(n), a= {
}
, u=0;
i.length>u;
...
var lo=Cr.getWeakData, ho=et.set, po=et.getterFor, vo=fe.find, go=fe.findIndex, yo=0, mo=function(t) {
...
, Ro= {
  store:Ao, getMap:Oo, has:function(t, e, r) {
  var n=Oo(e, r, !1);
...
,  {
  ...
  var r=arguments.length<3?void 0:Io(arguments[2]), n=To(j(e), r, !1);
...
return t.lastIndex=2, null!=t.exec("str")
  ...
  UNSUPPORTED_Y:ei, BROKEN_CARET:ri
}
, oi=I.f, ii=wt.f, ai=et.set, ui=qt("match"), si=n.RegExp, ci=si.prototype, fi=/a/g, li=/a/g, hi=new si(fi)!==fi, pi=ni.UNSUPPORTED_Y;
...
o++)void 0===arguments[o]&&(n[o]=void 0)
}
), n
}
);
var ji=xi;
Lt( {
  target:"RegExp", proto:!0, forced:/./.exec!==ji
}
,  {
  exec:ji
}
), i&&("g"!=/./g.flags||ni.UNSUPPORTED_Y)&&I.f(RegExp.prototype, "flags",  {
  configurable:!0, get:Zo
}
);
...
), Ni="$0"==="a".replace(/./, "$0"), Ci=qt("replace"), Fi=!!/./[Ci]&&""===/./[Ci]("a", "$0"), Bi=!o(function() {
  var t=/(?:)/, e=t.exec;
t.exec=function() {
...
, qi=Ie.charAt, zi=function(t, e, r) {
...
b++) {
  v=d[b];
for(var w=String(v[0]), S=Ki(Gi(st(v.index), f.length), 0), E=[], x=1;
x<v.length;
x++)E.push(void 0===(g=v[x])?g:String(g));
var A=v.groups;
if(l) {
...
for(var y=1;
y<=g.length-1;
y++)if(d.push(g[y]), d.length===l)return d;
p=h=v
}
}
...
var Zi=function() {
  for(var t=j(this), e=ee(t.add), r=0, n=arguments.length;
r<n;
r++)e.call(t, arguments[r]);
return t
}
;
Lt( {
...
,  {
  every:function(t) {
  var e=j(this), r=ta(e), n=re(t, arguments.length>1?arguments[1]:void 0, 3);
...
,  {
  filter:function(t) {
  var e=j(this), r=ta(e), n=re(t, arguments.length>1?arguments[1]:void 0, 3), o=new(hn(e, it("Set"))), i=ee(o.add);
return Fr(r, function(t) {
  n(t, t, e)&&i.call(o, t)
}
, void 0, !1, !0), o
...
,  {
  join:function(t) {
  var e=j(this), r=ta(e), n=void 0===t?", ":String(t), o=[];
...
,  {
  reduce:function(t) {
  var e=j(this), r=ta(e), n=arguments.length<2, o=n?void 0:arguments[1];
...
var ua=ra&&+ra, sa=qt("species"), ca=qt("isConcatSpreadable"), fa=9007199254740991, la="Maximum allowed index exceeded", ha=ua>=51||!o(function() {
  var t=[];
...
e<n;
e++)if(da(i=-1===e?a:arguments[e])) {
  if(s+(o=ft(i.length))>fa)throw TypeError(la);
for(r=0;
r<o;
r++, s++)r in i&&sr(u, s, i[r])
}
else {
...
.toString, ya="object"==typeof window&&window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[], ma= {
  f:function(t) {
...
)), t[xa][n]=!0), Wa(t, n, r)):Ua(t, n, r)
}
, Va=function(t, e) {
  j(t);
var r=g(e), n=zt(r).concat(Ja(r));
...
, defineProperty:$a, defineProperties:Va, getOwnPropertyDescriptor:Xa
}
), Lt( {
...
, xu=/Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(na), Au=Eu.start;
Lt( {
...
,  {
  raw:function(t) {
  for(var e=g(t.raw), r=ft(e.length), n=arguments.length, o=[], i=0;
r>i;
...
var Fu=qt("iterator"), Bu=!o(function() {
...
, e)).join("")!=n
  ...
  for(var r=Ut(t), n=arguments.length, o=1, a=St.f, u=c.f;
n>o;
)for(var s, f=d(arguments[o++]), l=a?zt(f).concat(a(f)):zt(f), h=l.length, p=0;
h>p;
)s=l[p++], i&&!u.call(f, s)||(r[s]=f[s]);
return r
}
:Du, Wu=2147483647, Ku=/[^\0-\u007E]/, Gu=/[.\u3002\uFF0E\uFF61]/g, $u="Overflow: input needs wider integers to process", Vu=Math.floor, Hu=String.fromCharCode, Xu=function(t) {
  return t+22+75*(t<26)
}
, Yu=function(t, e, r) {
  var n=0;
for(t=r?Vu(t/700):t>>1, t+=Vu(t/e);
t>455;
n+=36)t=Vu(t/35);
...
, Qu=it("fetch"), Zu=it("Headers"), ts=qt("iterator"), es="URLSearchParams", rs=es+"Iterator", ns=et.set, os=et.getterFor(es), is=et.getterFor(rs), as=/\+/g, us=Array(4), ss=function(t) {
  return us[t-1]||(us[t-1]=RegExp("((?:%[\\da-f] {
  2
}
) {
  "+t+"
...
, vs=function(t, e) {
  if(e)for(var r, n, o=e.split("&"), i=0;
i<o.length;
)(r=o[i++]).length&&(n=r.split("="), t.push( {
  key:fs(n.shift()), value:fs(n.join("="))
}
))
}
, gs=function(t) {
...
, ms=We(function(t, e) {
  ns(this,  {
  type:rs, iterator:cn(os(t).entries), kind:e
}
)
}
, "Iterator", function() {
...
if(ns(this,  {
  type:es, entries:f, updateURL:function() {
}
, updateSearchParams:gs
}
), void 0!==c)if(y(c))if("function"==typeof(t=vr(c)))for(r=(e=t.call(c)).next;
!(n=r.call(e)).done;
) {
  if((a=(i=(o=cn(j(n.value))).next).call(o)).done||(u=i.call(o)).done||!i.call(o).done)throw TypeError("Expected sequence with length 2");
f.push( {
  key:a.value+"", value:u.value+""
}
)
}
else for(s in c)w(c, s)&&f.push( {
  key:s, value:c[s]+""
}
);
...
for(var e=os(this), r=e.entries, n=t+"", o=0;
o<r.length;
...
, get:function(t) {
  ys(arguments.length, 1);
for(var e=os(this).entries, r=t+"", n=0;
n<e.length;
...
, getAll:function(t) {
  ys(arguments.length, 1);
for(var e=os(this).entries, r=t+"", n=[], o=0;
o<e.length;
o++)e[o].key===r&&n.push(e[o].value);
return n
}
, has:function(t) {
  ys(arguments.length, 1);
...
, set:function(t, e) {
  ys(arguments.length, 1);
for(var r, n=os(this), o=n.entries, i=!1, a=t+"", u=e+"", s=0;
s<o.length;
s++)(r=o[s]).key===a&&(i?o.splice(s--, 1):(i=!0, r.value=u));
i||o.push( {
  key:a, value:u
}
), n.updateURL()
...
, forEach:function(t) {
  for(var e, r=os(this).entries, n=re(t, arguments.length>1?arguments[1]:void 0, 3), o=0;
o<r.length;
...
,  {
  ...
  for(var t, e=os(this).entries, r=[], n=0;
n<e.length;
...
,  {
  fetch:function(t) {
  var e, r, n, o=[t];
return arguments.length>1&&(y(e=arguments[1])&&pr(r=e.body)===es&&((n=e.headers?new Zu(e.headers):new Zu).has("content-type")||n.set("content-type", "application/x-www-form-urlencoded;
charset=UTF-8"), e=Jt(e,  {
  body:f(0, String(r)), headers:f(0, n)
}
...
var Ss, Es= {
  URLSearchParams:bs, getState:os
}
, xs=Ie.codeAt, As=n.URL, Os=Es.URLSearchParams, Rs=Es.getState, js=et.set, Ps=et.getterFor("URL"), Is=Math.floor, Ts=Math.pow, ks="Invalid scheme", Ls="Invalid host", Us="Invalid port", Ms=/[A-Za-z]/, _s=/[\d+-.A-Za-z]/, Ns=/\d/, Cs=/^(0x|0X)/, Fs=/^[0-7]+$/, Bs=/^\d+$/, Ds=/^[\dA-Fa-f]+$/, qs=/[\u0000\u0009\u000A\u000D #%/:?@[\\]]/, zs=/[\u0000\u0009\u000A\u000D #/:?@[\\]]/, Ws=/^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g, Ks=/[\u0009\u000A\u000D]/g, Gs=function(t, e) {
  var r, n, o;
if("["==e.charAt(0)) {
...
for(e=0;
e<o.length;
e++)n.push(Ku.test(r=o[e])?"xn--"+Ju(r):r);
return n.join(".")
}
...
(t), r=0;
r<8;
r++)o&&0===t[r]||(o&&(o=!1), n===r?(e+=r?":":"::", o=!0):(e+=t[r].toString(16), r<7&&(e+=":")));
return"["+e+"]"
}
return t
}
...
for(r||(t.scheme="", t.username="", t.password="", t.host=null, t.port=null, t.path=[], t.query=null, t.fragment=null, t.cannotBeABaseURL=!1, e=e.replace(Ws, "")), e=e.replace(Ks, ""), o=gr(e);
f<=o.length;
) {
  switch(i=o[f], c) {
  case sc:if(!i||!Ms.test(i)) {
  if(r)return ks;
c=fc;
continue
}
...
break;
case cc:if(i&&(_s.test(i)||"+"==i||"-"==i||"."==i))l+=i.toLowerCase();
else {
  if(":"!=i) {
  if(r)return ks;
l="", c=fc, f=0;
...
break;
case fc:if(!n||n.cannotBeABaseURL&&"#"!=i)return ks;
...
c=Oc;
continue;
case pc:if(t.scheme=n.scheme, i==Ss)t.username=n.username, t.password=n.password, t.host=n.host, t.port=n.port, t.path=n.path.slice(), t.query=n.query;
...
break;
case vc:if(c=gc, "/"!=i||"/"!=l.charAt(f+1))continue;
f++;
break;
case gc:if("/"!=i&&"\\"!=i) {
  c=yc;
...
break;
case mc:case bc:if(r&&"file"==t.scheme) {
  c=xc;
continue
}
if(":"!=i||p) {
...
l+=i;
break;
case Sc:if(t.scheme="file", "/"==i||"\\"==i)c=Ec;
else {
  if(!n||"file"!=n.scheme) {
  c=Oc;
continue
...
break;
case Oc:if(i==Ss||"/"==i||"\\"==i&&ec(t)||!r&&("?"==i||"#"==i)) {
  if(".."===(s=(s=l).toLowerCase())||"%2e."===s||".%2e"===s||"%2e%2e"===s?(ac(t), "/"==i||"\\"==i&&ec(t)||t.path.push("")):uc(l)?"/"==i||"\\"==i&&ec(t)||t.path.push(""):("file"==t.scheme&&!t.path.length&&oc(l)&&(t.host&&(t.host=""), l=l.charAt(0)+":"), t.path.push(l)), l="", "file"==t.scheme&&(i==Ss||"?"==i||"#"==i))for(;
...
break;
case Rc:"?"==i?(t.query="", c=jc):"#"==i?(t.fragment="", c=Pc):i!=Ss&&(t.path[0]+=Zs(i, Xs));
break;
case jc:r||"#"!=i?i!=Ss&&("'"==i&&ec(t)?t.query+="%27":t.query+="#"==i?"%23":Zs(i, Xs)):(t.fragment="", c=Pc);
break;
case Pc:i!=Ss&&(t.fragment+=Zs(i, Ys))
}
f++
}
}
, Tc=function(t) {
  var e, r, n=Br(this, Tc, "URL"), o=arguments.length>1?arguments[1]:void 0, a=String(t), u=js(n,  {
  type:"URL"
}
);
if(void 0!==o)if(o instanceof Tc)e=Ps(o);
else if(r=Ic(e= {
}
...
var Vc, Hc, Xc, Yc=n.Promise, Jc=/(iphone|ipod|ipad).*applewebkit/i.test(na), Qc=n.location, Zc=n.setImmediate, tf=n.clearImmediate, ef=n.process, rf=n.MessageChannel, nf=n.Dispatch, of=0, af= {
}
, uf="onreadystatechange", sf=function(t) {
...
, Sf=R.f, Ef=wf.set, xf=n.MutationObserver||n.WebKitMutationObserver, Af=n.process, Of=n.Promise, Rf="process"==h(Af), jf=Sf(n, "queueMicrotask"), Pf=jf&&jf.value;
Pf||(hf=function() {
  var t, e;
for(Rf&&(t=Af.domain)&&t.exit();
pf;
) {
  e=pf.fn, pf=pf.next;
try {
...
, Ff=wf.set, Bf=qt("species"), Df="Promise", qf=et.get, zf=et.set, Wf=et.getterFor(Df), Kf=Yc, Gf=n.TypeError, $f=n.document, Vf=n.process, Hf=it("fetch"), Xf=_f.f, Yf=Xf, Jf="process"==h(Vf), Qf=!!($f&&$f.createEvent&&n.dispatchEvent), Zf="unhandledrejection", tl=Tt(Df, function() {
  if(F(Kf)===String(Kf)) {
  if(66===ua)return!0;
...
var n=e.reactions;
Uf(function() {
  for(var o=e.value, i=1==e.state, a=0;
n.length>a;
) {
...
, (If=function(t) {
  zf(this,  {
  type:Df, done:!1, notified:!1, parent:!1, reactions:[], rejection:!1, state:0, value:void 0
}
)
}
...
dl.prototype=Jt(Error.prototype,  {
  constructor:f(5, dl), message:f(5, ""), name:f(5, "AggregateError")
}
...
, t instanceof Rl?t.forEach(function(t, e) {
  this.append(e, t)
}
...
charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type", this._bodyBlob.type):gl&&URLSearchParams.prototype.isPrototypeOf(t)&&this.headers.set("content-type", "application/x-www-form-urlencoded;
charset=UTF-8"))
}
...
), this.type="default", this.status=void 0===e.status?200:e.status, this.ok=this.status>=200&&this.status<300, this.statusText="statusText"in e?e.statusText:"OK", this.headers=new Rl(e.headers), this.url=e.url||"", this._initBody(t)
}
...
, kl.call(Ul.prototype), kl.call(_l.prototype), _l.prototype.clone=function() {
  ...
  status:this.status, statusText:this.statusText, headers:new Rl(this.headers), url:this.url
}
)
}
, _l.error=function() {
...
i.onload=function() {
  var t, e, n= {
  status:i.status, statusText:i.statusText, headers:(t=i.getAllResponseHeaders()||"", e=new Rl, t.replace(/\r?\n[\t ]+/g, " ").split(/\r?\n/).forEach(function(t) {
